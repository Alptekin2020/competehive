...
export default function TagManagerModal({ onClose, onUpdated }: TagManagerModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center px-0 sm:px-6">
      ...
      <div className="bg-[#111113] border border-[#1F1F23] rounded-t-2xl sm:rounded-2xl p-5 sm:p-6 w-full sm:max-w-md relative z-10 max-h-[85vh] overflow-y-auto safe-bottom">
