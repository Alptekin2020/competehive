    ...
    <div className="min-h-screen bg-dark-1000 flex items-center justify-center px-6">
      <div className="w-full max-w-md">
        ...
        <div className="bg-dark-900 border border-dark-800 rounded-2xl p-8">
          ...
          <p className="text-dark-500 text-sm mb-8">Ücretsiz başlayın, 5 ürüne kadar takip edin.</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-dark-300 mb-2">İsim</label>
              <input
                type="text"
                value={form.name}
        ...
        <p className="text-center text-dark-500 text-sm mt-6">
          ...
          <Link href="/login" className="text-hive-500 hover:text-hive-400 transition">Giriş Yap</Link>
        </p>
      </div>
    </div>
  );
